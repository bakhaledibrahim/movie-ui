...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 p-4 z-50 flex justify-between items-center transition-colors duration-500 ${isScrolled ? 'bg-black' : 'bg-gradient-to-b from-black to-transparent'}`}>
            ...
            <div className="flex items-center space-x-4">
                <div className="flex items-center">
                    ...
                    <input
                        ...
                        className={`bg-black text-white border border-white ml-2 p-1 transition-all duration-300 ${isSearchOpen ? 'w-48 opacity-100' : 'w-0 opacity-0'}`}
                    />
                </div>
